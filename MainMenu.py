...
class MainMenu:
    ...
    def __init__(self, root):
        ...
        self.add_book_button = Button(self.frame, text="Add Book", width=35, pady=10, command=self.change_add_book,
                                      font='Dubai 16', fg='#271c19', bg='#ffc0ad', activebackground="#ffc0ad",
                                      activeforeground="#271c19")
        ...
        self.exit_button = Button(self.frame, text="Exit", command=self.exit_funct, width=35, pady=10, font='Dubai 16',
                                  fg='#271c19', bg='#ffc0ad', activebackground="#ffc0ad", activeforeground="#271c19")
